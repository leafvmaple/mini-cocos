...
private:
    ...
    using ListenerCondition = mstd::function<bool(const ListenerEntry&)>;
    using ListenerEvent = mstd::function<bool(ListenerEntry&)>;
    ...
    int _inDispatch = 0;
    mstd::unordered_map<int, EventListenerVector> _listenerMap;
