...
// Named MiniMath.h on purpose: on Windows, "Math.h" can hijack #include <math.h> (case-insensitive FS).
...
inline Mat4 nodeLocalMatrix(const Vec2& position, const Vec2& scale, float rotationDegrees,
